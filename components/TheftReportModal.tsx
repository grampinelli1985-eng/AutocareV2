        ...
        <div className="fixed inset-0 z-[180] flex items-center justify-center p-6 bg-slate-900/60 backdrop-blur-sm">
            <div className="bg-white dark:bg-slate-900 w-full max-w-sm rounded-[32px] p-6 shadow-2xl space-y-4 animate-in zoom-in-95 max-h-[90vh] overflow-y-auto">
                ...
                <form onSubmit={onSubmit} className="space-y-4">
                    <div className="bg-indigo-50 dark:bg-indigo-950/30 p-4 rounded-2xl border border-indigo-100 dark:border-indigo-800/50 flex gap-3 items-start animate-in slide-in-from-top-2">
                        <div className="bg-indigo-100 dark:bg-indigo-900/40 p-1.5 rounded-lg text-indigo-700 dark:text-indigo-300 mt-0.5"><ShieldAlert size={14} /></div>
                        <div className="space-y-1">
                            <p className="text-[11px] font-black text-indigo-700 dark:text-indigo-300 uppercase">Divulgação de Localização</p>
                            <p className="text-[10px] text-indigo-700 dark:text-indigo-300/80 leading-tight">
                                O AutoCare acessa sua localização para validar o raio de 100km de alcance dos alertas comunitários (Plano Free) e para marcar o ponto inicial da ocorrência no mapa.
                            </p>
                        </div>
                    </div>
                    ...
                    {userPlan === 'free' && (
                        <div className="bg-amber-50 dark:bg-amber-950/20 p-4 rounded-2xl border border-amber-100 flex gap-3 items-start animate-in slide-in-from-top-2">
                            ...
                            <p className="text-[11px] font-bold text-amber-800 dark:text-amber-300 leading-tight">Usuários do plano Free emitem alertas em um raio de 100 km. Para alcance nacional, ative o plano Premium.</p>
                        </div>
                    )}
