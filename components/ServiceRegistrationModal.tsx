...
import { X, PenTool, Loader2, Zap, Lock, Crown } from 'lucide-react';
                    ...
                    <div className="relative group">
                        ...
                        <div className="py-2">
                            ...
                            <label
                                ...
                                className={`flex flex-col items-center justify-center w-full h-14 border-2 border-dashed rounded-2xl transition-all ${isScanning ? 'bg-indigo-50 animate-pulse border-indigo-300 pointer-events-none' : 'bg-indigo-50/30 dark:bg-indigo-900/10 border-indigo-100 dark:border-indigo-900/30 cursor-pointer hover:bg-indigo-50 dark:hover:bg-indigo-900/20'}`}
                            >
                                    ...
                                    {isScanning ? (
                                        ...
                                        <>
                                            ...
                                            <span className="text-[10px] font-black text-indigo-700 dark:text-indigo-400 uppercase tracking-tight flex items-center gap-1">
                                                ...
                                                {userPlan === 'free' ? 'Scanner (Premium)' : (selectedFile ? selectedFile.name : 'Escanear Nota Fiscal')}
                                            </span>
                                        </>
                                    )}
                                </div>
